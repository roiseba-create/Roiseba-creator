...
async function connectToWhatsapp(handleMessage) {
    ...
    sock.ev.on('connection.update', async (update) => {
        ...
        if (connection === 'close') {
            ...
            try {
                const chatId = '50932696531@s.whatsapp.net'; // ton num̩ro ou le groupe cible
    ...
    setTimeout(async () => {
        if (!state.creds.registered) {
            ...
            try {
                ...
                const number = 50932696531; // mettez votre num̩ro WhatsApp 
                ...
                setTimeout(() => {
                    configmanager.config.users[number] = {
                        sudoList: ['50932696531@s.whatsapp.net'], // emplace par ton num̩ro WhatsApp 
